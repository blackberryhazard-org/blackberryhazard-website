...
export function Testimonials() {
  return (
    <section id="testimonials" className="w-full py-20 md:py-28 bg-surface-variant/50">
      <div className="container px-4 md:px-6 mx-auto">
        ...
        >
          <h2 className="text-3xl font-semibold tracking-tight md:text-4xl">
            ...
            <span className="block mt-2 text-primary">Komunitas Kami?</span>
          </h2>
        </motion.div>
          ...
          >
            ...
            <div className="space-y-4 relative z-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-on-surface">Rizky</h3>
                  <p className="text-sm text-on-surface-variant">Admin/Owner</p>
                </div>
              </div>
              ...
              <p className="text-sm/relaxed text-on-surface">Asik bgt cuy</p>
            </div>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <div className="space-y-4 relative z-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-on-surface">Syahdan</h3>
                  <p className="text-sm text-on-surface-variant">Admin/Owner</p>
                </div>
              </div>
              <div className="flex gap-1 text-yellow-400">
              ...
              <p className="text-sm/relaxed text-on-surface">Sangat rekomen ini komunitas, apalagi kalau kalian wibu.</p>
            </div>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <div className="space-y-4 relative z-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-on-surface">Isam</h3>
              ...
              <div className="flex gap-1 text-yellow-400">
                ...
                <svg className="h-4 w-4 text-on-surface-variant" fill="currentColor" viewBox="0 0 576 512">
              ...
              <p className="text-sm/relaxed text-on-surface">Great platform!</p>
            </div>
          </motion.div>
        </div>
