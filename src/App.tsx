      ...
      <header className="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium">
            ...
            <a href="https://imphnen.dev/events" className="text-muted-foreground hover:text-foreground transition-colors">Event</a>
            <a href="https://imphnen.dev/testimonials" className="text-muted-foreground hover:text-foreground transition-colors">Testimoni</a>
            <a href="https://imphnen.dev/#community" className="bg-primary text-primary-foreground px-4 py-2 rounded-lg hover:bg-primary/90 transition-colors">
              Join
            </a>
          </nav>
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Komunitas programmer terbesar di Indonesia, tempat berbagi
                    meme, tutorial, pengalaman dan yapping
                  </p>
                </div>
          ...
          <div className="container px-4 md:px-6 mx-auto">
            ...
            <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
              {[
                {
                  name: "Facebook",
                  desc: "Join discussions and share knowledge",
                  color: "text-[#1877F2]",
                ...
                {
                  name: "Discord",
                  desc: "Real-time collaboration chat",
                  color: "text-[#5865F2]",
                ...
                },
                {
                  ...
                  icon: (
                    <svg fill="currentColor" viewBox="0 0 448 512" className="w-8 h-8">
                      <path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.83-48.3 93.97 0 111.28 61.9 111.28 142.3V448z"></path>
                    </svg>
                  ),
                },
              ].map((platform, index) => (
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground w-full max-w-xs">
                Komunitas programmer terbesar di Indonesia, tempat berbagi meme, tutorial, pengalaman dan yapping.
              </p>
            </div>
